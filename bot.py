...
# --- Konfiguratsiya va Global O'zgaruvchilar ---import asyncio
import json
import os
from aiogram import Bot, Dispatcher, types, F
from aiogram.types import InlineKeyboardMarkup, InlineKeyboardButton, ReplyKeyboardMarkup, KeyboardButton
...
# --- 4. Pasport ma'lumotini qabul qilish va barchasini yuborish ---
...
async def process_passport(message: types.Message, state: FSMContext):
    ...
    # Birinchi hujjatga yakuniy captionni qo'shamiz
...
# --- Orqaga Qaytish Funksiyalari (Yangi State'larga moslashtirildi) ---
...
# --- Admin Panel Funksiyalari (avvalgidek qoldi) ---
